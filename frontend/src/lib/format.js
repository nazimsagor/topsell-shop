...
//
// Use these helpers instead of hand-rolling `$${value.toFixed(0)}` in JSX.

export const CURRENCY_SYMBOL = '৳';

/**
 * Format a number as BDT. Always returns "৳X,XXX" (whole taka).
 * BDT pricing in retail typically uses no decimals.
