              ...
              {items.map((item) => {
                ...
                return (
                  <div key={item.id} className="flex gap-3 items-center">
                    ...
                    <p className="font-semibold text-sm">৳{(price * qty).toFixed(0)}</p>
                  </div>
                );
              })}
            </div>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-5">
            ...
            <div className="space-y-2 text-sm">
              ...
              <div className="flex justify-between"><span className="text-gray-600">Shipping</span><span>{shippingCost === 0 ? <span className="text-green-600">Free</span> : `৳${shippingCost.toFixed(0)}`}</span></div>
              <div className="flex justify-between"><span className="text-gray-600">Tax</span><span>৳{tax.toFixed(0)}</span></div>
              <div className="flex justify-between font-bold text-base border-t pt-2 mt-2"><span>Total</span><span>৳{total.toFixed(0)}</span></div>
            </div>
          </div>
